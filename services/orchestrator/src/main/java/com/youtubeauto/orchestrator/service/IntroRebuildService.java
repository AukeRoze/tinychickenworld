...
public class IntroRebuildService {
    ...
    static final String IDENTITY_LOCK =
            ...
            + "accessories: Pip is the SMALLEST — a tiny, petite, perfectly ROUND PURE-WHITE "
            + "chick (clean white down, NEVER cream or yellow — she is not the yellow duckling) "
            + "wearing a STRAW HAT and a RED neck bandana (no glasses). Mo is the "
